@echo off
rem COMSOL AI App launcher (ASCII only - do not add non-English text here)
...
echo.
echo Server running at http://127.0.0.1:8712  (closing this window stops the app)
echo.
".venv\Scripts\python.exe" -m uvicorn backend.main:app --host 127.0.0.1 --port 8712
pause
exit /b 0
